...
namespace WindowsFormsApp1
{
  public partial class Main : Form
  {
    ...
    public struct FactorySetting
    {
      ...
      public UInt32 Rated_Capacity;
      public UInt32 Rated_Voltage;
      public UInt64 BMS_SN;
      public UInt64 Project_Code;
    }
    //阈值信息
    [StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 1)]
    ...
    *************************************************************************/
    ...
    private void uiSymbolButton1_Click(object sender, EventArgs e)
    {
      ...
      f.ShowDialog();
      Serial_Data_Transmission(Null, 8, Main.frm1.RACK_ID_Number_Sent, Main.frm1.Shelf_ID_Number_Sent, 0x11);
